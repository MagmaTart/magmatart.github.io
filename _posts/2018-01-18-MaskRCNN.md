...
::memo: __논문 리딩 스터디 #11__: Two-Stage Detector의 SOTA를 넘어 Instance Segmentation이라는 분야를 개척한 Mask R-CNN 논문을 읽고 정리해봅니다.
...
<p align="center"><image width="600" src="/assets/posts/images/MaskRCNN/RoIPooling.PNG"/></p>
...
<p align="center"><image width="600" src="/assets/posts/images/MaskRCNN/RoIAlign.PNG"/></p>
...
<p align="center"><image width="700" src="/assets/posts/images/MaskRCNN/MaskrcnnStructure.PNG"/></p>
...
<p align="center"><image width="600" src="/assets/posts/images/MaskRCNN/MaskrcnnResult.PNG"/></p>

FPN 구조가 Backbone에 들어가있는 덕분에 여러 크기의 물체를 잘 감지하고, 또 Masking도 잘 하고 있는 모습을 볼 수 있습니다.

아래는 COCO 데이터셋 내의 이미지들에 대한 결과입니다.

<p align="center"><image width="600" src="/assets/posts/images/MaskRCNN/cocoresult.PNG"/></p>
