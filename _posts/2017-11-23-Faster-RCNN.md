...
:memo: __논문 리딩 스터디 #2__: Two-Stage Object Detector의 주요 논문인 Faster R-CNN을 정리해봅니다.

<!--more-->
-----
논문 링크: [Faster R-CNN: Towards Real-Time Object Detection with Region Proposal Networks](https://arxiv.org/pdf/1506.01497.pdf)

Faster R-CNN은 Object Detection 모델로, 2016년에 Microsoft에서 내놓은 주요 연구 성과 중 하나입니다.
R-CNN과 Fast R-CNN에 기반한 네트워크 구조이므로, 그 둘부터 시작해 순서대로 정리하겠습니다.
...
<p align="center"><image width="500" src="/assets/posts/images/FasterRCNN/BB.png"/></p>
...
<p align="center"><image width="300" src="/assets/posts/images/FasterRCNN/FasterRCNN.png"/></p>
...
<p align="center"><image width="450" src="/assets/posts/images/FasterRCNN/FasterRCNN_Anchor.png"/></p>
...
<p align="center"><image src="/assets/posts/images/FasterRCNN/FasterRCNN2.png"/></p>
